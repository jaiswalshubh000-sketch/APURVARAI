  ...
  return (
    ...
    >
      ...
      <ProjectSection title="Concept Art & World Building">
        ...
        <div className="w-full rounded-xl overflow-hidden border border-white/10 bg-zinc-900 h-[600px] mb-12">
          <iframe 
            src="https://drive.google.com/embeddedfolderview?id=1yisIvRAskO53i6ihBHou1ow6ppWnT_5O#grid" 
            width="100%" 
            height="100%" 
            style={{ border: 'none' }}
            title="Concept Art Folder"
          ></iframe>
        </div>
